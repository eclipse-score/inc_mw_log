...
#ifndef PLATFORM_AAS_MW_LOG_LOGGING_H
#define PLATFORM_AAS_MW_LOG_LOGGING_H
...
///
/// \details In a normal case the user does not want to use this API. It is only exposed e.g. for testing purposes
void SetLogRecorder(bmw::mw::log::Recorder* const recorder) noexcept;

}  // namespace log
}  // namespace mw
}  // namespace bmw

#endif  // PLATFORM_AAS_MW_LOG_LOGGING_H

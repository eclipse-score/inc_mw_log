...
#ifndef PLATFORM_AAS_MW_LOG_LOG_STREAM_FACTORY_H
#define PLATFORM_AAS_MW_LOG_LOG_STREAM_FACTORY_H
...
class LogStreamFactory
{
  public:
    ...
    static LogStream GetStream(const LogLevel, const amp::string_view context_id = "DFLT") noexcept;
...
#endif  // PLATFORM_AAS_MW_LOG_LOG_STREAM_FACTORY_H

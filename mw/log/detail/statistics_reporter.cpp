                                 ...
                                 const std::size_t& slot_size_bytes) noexcept
{
    ...
    if ((no_slot_available_counter > 0) || (message_too_long_counter > 0))
    {
    ...
    recorder.Log(slot.value(), amp::string_view{"mw::log statistics: number_of_slots="});
    recorder.Log(slot.value(), number_of_slots);
    recorder.Log(slot.value(), amp::string_view{", slot_size_bytes="});
    recorder.Log(slot.value(), slot_size_bytes);
    recorder.Log(slot.value(), amp::string_view{", no_slot_available_counter="});
    recorder.Log(slot.value(), no_slot_available_counter);
    recorder.Log(slot.value(), amp::string_view{", message_too_long_counter="});

...
{
    RecordProperty("ParentRequirement", ", , PRS_Dlt_00423, PRS_Dlt_00369");
...
TEST_F(DLTFormatFixture, TypeInformationForString)
{
    ...
    DLTFormat::Log(payload_, amp::string_view{"Hello World"});
...
TEST_F(DLTFormatFixture, TypeInformationForUint8InHex)
{
    ...
    DLTFormat::Log(payload_, std::uint8_t{42U}, bmw::mw::log::detail::IntegerRepresentation::kHex);
...
TEST_F(DLTFormatFixture, TypeInformationForHex8InHex)
{
    ...
    DLTFormat::Log(payload_, LogHex8{0xFF}, bmw::mw::log::detail::IntegerRepresentation::kHex);
...
TEST_F(DLTFormatFixture, TypeInformationForHex16InHex)
{
    ...
    DLTFormat::Log(payload_, LogHex16{0xFFFF}, bmw::mw::log::detail::IntegerRepresentation::kHex);
...
TEST_F(DLTFormatFixture, TypeInformationForHex32InHex)
{
    ...
    DLTFormat::Log(payload_, LogHex32{0xFFFFFF}, bmw::mw::log::detail::IntegerRepresentation::kHex);
...
TEST_F(DLTFormatFixture, TypeInformationForHex64InHex)
{
    ...
    DLTFormat::Log(payload_, LogHex64{0xFFFFFFFF}, bmw::mw::log::detail::IntegerRepresentation::kHex);
...
TEST_F(DLTFormatFixture, TypeInformationForBin8InBin)
{
    ...
    DLTFormat::Log(payload_, LogBin8{0xFF}, bmw::mw::log::detail::IntegerRepresentation::kBinary);
...
TEST_F(DLTFormatFixture, TypeInformationForBin16InBin)
{
    ...
    DLTFormat::Log(payload_, LogBin16{0xFFFF}, bmw::mw::log::detail::IntegerRepresentation::kBinary);
...
TEST_F(DLTFormatFixture, TypeInformationForBin32InBin)
{
    ...
    DLTFormat::Log(payload_, LogBin32{0xFFFFFF}, bmw::mw::log::detail::IntegerRepresentation::kBinary);
...
TEST_F(DLTFormatFixture, TypeInformationForBin64InBin)
{
    ...
    DLTFormat::Log(payload_, LogBin64{0xFFFFFFFF}, bmw::mw::log::detail::IntegerRepresentation::kBinary);
...
TEST_F(DLTFormatFixture, TypeInformationForUint16InHex)
{
    ...
    DLTFormat::Log(payload_, std::uint16_t{0xABCD}, bmw::mw::log::detail::IntegerRepresentation::kHex);
...
TEST_F(DLTFormatFixture, TypeInformationForUint32InHex)
{
    ...
    DLTFormat::Log(payload_, std::uint32_t{0xABCDEF00}, bmw::mw::log::detail::IntegerRepresentation::kHex);
...
TEST_F(DLTFormatFixture, TypeInformationForUint64InHex)
{
    ...
    DLTFormat::Log(payload_, std::uint64_t{0xABCDEF00ABCDEF00}, bmw::mw::log::detail::IntegerRepresentation::kHex);
...
TEST_F(DLTFormatFixture, TypeInformationUInt8InBinary)
{
    ...
    DLTFormat::Log(payload_, std::uint8_t{42U}, bmw::mw::log::detail::IntegerRepresentation::kBinary);
...
TEST_F(DLTFormatFixture, TypeInformationUint16InBinary)
{
    ...
    DLTFormat::Log(payload_, std::uint16_t{0xABCD}, bmw::mw::log::detail::IntegerRepresentation::kBinary);
...
TEST_F(DLTFormatFixture, TypeInformationUint32InBinary)
{
    ...
    DLTFormat::Log(payload_, std::uint32_t{0xABCDEF00}, bmw::mw::log::detail::IntegerRepresentation::kBinary);
...
TEST_F(DLTFormatFixture, TypeInformationUint64InBinary)
{
    ...
    DLTFormat::Log(payload_, std::uint64_t{0xABCDEF00ABCDEF00}, bmw::mw::log::detail::IntegerRepresentation::kBinary);

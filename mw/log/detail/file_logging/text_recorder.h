...
#ifndef PLATFORM_AAS_MW_LOG_TEXT_RECORDER_H_
...
class TextRecorder : public Recorder
{
  public:
    ...
    void Log(const SlotHandle& slot, const amp::string_view data) noexcept override;
    ...
    bool IsLogEnabled(const LogLevel&, const amp::string_view) const noexcept override;
...
#endif  //  PLATFORM_AAS_MW_LOG_TEXT_RECORDER_H_

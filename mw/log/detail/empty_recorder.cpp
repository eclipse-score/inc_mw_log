...
amp::optional<SlotHandle> EmptyRecorder::StartRecord(const amp::string_view, const LogLevel) noexcept
{
    return {};
}
...
void EmptyRecorder::Log(const SlotHandle&, const amp::string_view) noexcept {}
...
bool EmptyRecorder::IsLogEnabled(const LogLevel&, const amp::string_view) const noexcept
{
    return false;
}

...
LinearReader::LinearReader(const amp::span<Byte>& data) noexcept : data_{data}, read_index_{} {}

std::optional<amp::span<Byte>> LinearReader::Read() noexcept
{
    ...
    // 
    const auto dst_span = amp::span<Byte>{static_cast<Byte*>(static_cast<void*>(&length)), sizeof(length)};

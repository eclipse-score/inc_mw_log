...
#ifndef PLATFORM_AAS_MW_LOG_SLOT_HANDLE_H
#define PLATFORM_AAS_MW_LOG_SLOT_HANDLE_H
...
class SlotHandle final
{
  public:
    ...
    static constexpr std::size_t kMaxRecorders{4};
...
#endif  // PLATFORM_AAS_MW_LOG_SLOT_HANDLE_H

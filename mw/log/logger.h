...
#ifndef PLATFORM_AAS_MW_LOG_LOGGER_H
#define PLATFORM_AAS_MW_LOG_LOGGER_H
...
class Logger final
{
  ...
  public:
    ...
    /// \public
    /// \thread-safe
    explicit Logger(const amp::string_view context) noexcept;
    ...
    amp::string_view GetContext() const noexcept;
